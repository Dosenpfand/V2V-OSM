...
class Pathloss:
    ...
    def pathloss_nlos(self, dist_rx, dist_tx):
        ...
        sf_loss = np.random.normal(0, self.nlos_config['standard_dev'], np.size(dist_rx))
    ...
    def pathloss_los(self, dist):
        ...
        sf_loss = np.random.normal(0, self.los_config['standard_dev'], np.size(dist))
    ...
    def pathloss_olos(self, dist):
        ...
        sf_loss = np.random.normal(0, self.olos_config['standard_dev'], np.size(dist))
